...
class RPC:
    ...
    async def handle(self, request):
        ...
        try:
            ...
            elif operation in ('service_network_create', 'service_network_delete'):
                from .networks import dispatch
                future = self.controller._submit(('network', params['identity'], operation),
                                                  dispatch, self.controller, operation, params['identity'])
                if future is None:
